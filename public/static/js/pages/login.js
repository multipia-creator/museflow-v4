    ...
    container.innerHTML = `
      ...
      ">
        ...
        ">
          ...
          ">
            <img src="/static/images/logo-square.png" alt="MuseFlow" style="height: 80px; width: 80px; border-radius: 16px; box-shadow: 0 0 20px rgba(139, 92, 246, 0.6); mix-blend-mode: screen; background: transparent;">
          </div>
